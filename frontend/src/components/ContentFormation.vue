    ...
    <div class="container-fluid">
      ...
      <div class="row mb-3" v-if="formation !== null">
        <div class="col-md-6 text-left">
          <div>
            <b-card
              :title="formation.specialite"
              :sub-title="formation.site_web_url"
            >
              <b-card-text>
              ...
              <b-card-text
                ...
                <span
                  class="font-italic"
                  >{{formation.alternance | bool2txt}}</span
                ></b-card-text
              >
              <b-card-text
                >Type :
                <span
                  class="font-italic"
                  >{{formation.type_formation| bool2type}}</span
                ></b-card-text
              >
            ...
            <b-tabs card>
              <b-tab title="Responsable" active class="text-left">
                <b-card-text
                  >Nom:
                  <span class="font-italic"
                    >{{formation.responsable.prenom_responsable | capitalize}}
                    {{formation.responsable.nom_responsable | capitalize}}</span
                  ></b-card-text
                >
                <b-card-text
                  >Mail:
                  <span class="font-italic"
                    >{{formation.responsable.mail_responsable | capitalize}}
                  </span></b-card-text
                >
                <b-card-text
                  >Telephone:
                  <span class="font-italic"
                    >{{formation.responsable.telephone_responsable }}
                  </span></b-card-text
                >
              </b-tab>
              <b-tab title="Dans la même école">
                <ul class="list-group">
                  <li
                    v-for="item in formation.formations"
                ...
                <div class="text-left">
                  <b-card>
                    <b-card-text
                      >Visio:
                      <span
                        v-if="formation.ForumInfo != null"
                        class="font-italic"
                        >{{formation.ForumInfo.lien_visio }}</span
                      ></b-card-text
                    >
                    <b-card-text
                      >Video:
                      <span
                        v-if="formation.ForumInfo != null"
                        class="font-italic"
                        >{{formation.ForumInfo.lien_video }}
                      </span></b-card-text
                    >
                  </b-card>
                </div>
        ...
        <div class="col-md-4 mb-4">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              ...
              <button type="button" class="btn btn-primary ml-2" v-b-modal.modal-ajoutformation>
...
<script>
  ...
  import Modal from "./modal/modalFormation.vue"
